  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh flex-col transition-[width] ease-linear md:flex",
